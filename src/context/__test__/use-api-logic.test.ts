...
describe("useAPILogic", () => {
  ...
  it(
    "returns null when password is missing",
    () => {
  ...
  it(
    "returns null when username is missing",
    () => {
  ...
  it(
    "returns null when serverAddress is missing",
    () => {
  ...
  it(
    "returns null when all credentials are missing",
    () => {
  ...
  it(
    "returns a SubsonicAPI instance when credentials are complete",
    () => {
  ...
  it(
    "creates SubsonicAPI with correct url and auth config",
    () => {
      const authState = makeAuthState();
  ...
  it(
    "generates a salt from crypto random bytes",
    () => {
      const authState = makeAuthState();
      useAPILogic(authState);
  ...
  it(
    "custom fetch calls global fetch with the original params",
    async () => {
      const authState = makeAuthState();
      useAPILogic(authState);
      const MockSubsonicAPI = SubsonicAPI as jest.MockedClass<typeof SubsonicAPI>;
  ...
  it(
    "custom fetch logs the request info via appLogger",
    async () => {
      const authState = makeAuthState();
      useAPILogic(authState);
      const MockSubsonicAPI = SubsonicAPI as jest.MockedClass<typeof SubsonicAPI>;
  ...
  it(
    "custom fetch handles invalid URL strings gracefully",
    async () => {
      const authState = makeAuthState();
      useAPILogic(authState);
      const MockSubsonicAPI = SubsonicAPI as jest.MockedClass<typeof SubsonicAPI>;
  ...
  it(
    "custom fetch passes through non-string params directly",
    async () => {
      const authState = makeAuthState();
      useAPILogic(authState);
      const MockSubsonicAPI = SubsonicAPI as jest.MockedClass<typeof SubsonicAPI>;
